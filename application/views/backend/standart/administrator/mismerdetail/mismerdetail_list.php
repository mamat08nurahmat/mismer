                       ...
                       <?php else: ?>
                         ...
                         <?php foreach($mismerdetails as $mismerdetail): ?>
                            <tr>
                               ...
                               <!-- <td><?= _ent($mismerdetail->Q_CODE); ?></td> -->
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-3 padd-left-0 " >
                        <select type="text" class="form-control chosen chosen-select" name="f" id="field" >
                           ...
                           <option <?= $this->input->get('f') == 'Q_CODE' ? 'selected' :''; ?> value="Q_CODE">Q_CODE</option>
                           <option <?= $this->input->get('f') == 'TYPE_MID' ? 'selected' :''; ?> value="TYPE_MID">TYPE_MID</option>
