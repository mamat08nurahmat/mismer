         ...
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <form name="form_mismerdetail" id="form_mismerdetail" action="<?= base_url('administrator/mismerdetail/dev'); ?>">
...
<div class="row">
   <div class="col-md-8">
      ...
      <div class="col-sm-2 padd-left-0 ">
         <button type="button" class="btn btn-flat" name="apply" id="apply" title="<?= cclang('apply_bulk_action'); ?>"><?= 'UPDATE'; ?></button>
      </div>
      <div class="col-sm-3 padd-left-0  " >
         <input type="date" data-date-format="YYYY-MM-DD" class="form-control" name="q" id="filter" placeholder="<?= cclang('filter'); ?>" value="<?= $this->input->get('q'); ?>">
      </div>
      <div class="col-sm-3 padd-left-0 " >
      ...
      if (bulk.val() == 'exh') {
         swal({
           ...
           // text: "<?= cclang('data_to_be_deleted_can_not_be_restored'); ?>",
            ...
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "<?= cclang('Approve'); ?>",
            cancelButtonText: "<?= cclang('no_cancel_plx'); ?>",
            closeOnConfirm: true,
            closeOnCancel: true
          },
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/administrator/mismerdetail/exh?' + serialize_bulk;
            }
          });
