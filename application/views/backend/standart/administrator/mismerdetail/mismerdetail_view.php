...
<section class="content-header">
   <h1>
      Mismerdetail      <small><?= cclang('detail', ['Mismerdetail']); ?> </small>
   </h1>
   <ol class="breadcrumb">
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">Detail Mismerdetail</h5>
                     <hr>
                  </div>
                  ...
                  <div class="form-horizontal" name="form_mismerdetail" id="form_mismerdetail" >
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($mismerdetail->MERCHAN_DBA_NAME); ?>
                        </div>
                    </div>
