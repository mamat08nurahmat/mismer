...
<section class="content-header">
    <h1>
        Mismerunmatch        <small><?= cclang('new', ['Mismerunmatch']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Mismerunmatch']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <b>Input TYPE MID</b> Max Length : 45.</small>
                                                ...
                                                <div class="form-group ">
                            <label for="ISUPDATE" class="col-sm-2 control-label">ISUPDATE 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="ISUPDATE" id="ISUPDATE" placeholder="ISUPDATE" value="<?= set_value('ISUPDATE'); ?>">
                                <small class="info help-block">
                                <b>Input ISUPDATE</b> Max Length : 11.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/mismerunmatch/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
