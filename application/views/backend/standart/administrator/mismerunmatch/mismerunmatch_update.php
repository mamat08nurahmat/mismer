                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/mismerunmatch/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="RowID" id="RowID" placeholder="RowID" value="<?= set_value('RowID', $mismerunmatch->RowID); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="ISUPDATE" id="ISUPDATE" placeholder="ISUPDATE" value="<?= set_value('ISUPDATE', $mismerunmatch->ISUPDATE); ?>">
                                <small class="info help-block">
