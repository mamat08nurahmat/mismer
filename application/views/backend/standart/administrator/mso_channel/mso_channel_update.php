...
<section class="content-header">
    <h1>
        Mso Channel        <small>Edit Mso Channel</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Mso Channel</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/mso_channel/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_mso_channel', 
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/mso_channel';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        var form_mso_channel = $('#form_mso_channel');
        var data_post = form_mso_channel.serializeArray();
        ...
        $.ajax({
          url: form_mso_channel.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#mso_channel_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
