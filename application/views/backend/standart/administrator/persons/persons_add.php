...
<section class="content-header">
    <h1>
        Persons        <small><?= cclang('new', ['Persons']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Persons']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_persons', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="LastName" id="LastName" placeholder="LastName" value="<?= set_value('LastName'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="FirstName" id="FirstName" placeholder="FirstName" value="<?= set_value('FirstName'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="persons_image_uuid" id="persons_image_uuid" type="hidden" value="<?= set_value('persons_image_uuid'); ?>">
                                <input class="data_file" name="persons_image_name" id="persons_image_name" type="hidden" value="<?= set_value('persons_image_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/persons/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_image = $('#persons_image_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_image !== 'undefined') {
                    $('#persons_image_galery').fineUploader('deleteFile', id_image);
                }
