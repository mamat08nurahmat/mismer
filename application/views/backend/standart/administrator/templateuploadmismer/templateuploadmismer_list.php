               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <table id="datatables" class="display" style="width:100%">
                     ...
                     <?php foreach($templateuploadmismers as $templateuploadmismer): ?>
                        <tr>
                           <td width="5">
                              <input type="checkbox" class="flat-red check" name="id[]" value="<?= $templateuploadmismer->RowID; ?>">
                           </td>
                           ...
                           <td><?= _ent(format_opendate_cardlink($templateuploadmismer->OPEN_DATE)); ?></td>
                           <td><?= _ent($templateuploadmismer->CITY); ?></td>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/templateuploadmismer/view/' . $templateuploadmismer->RowID); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> <?= cclang('view_button'); ?>
                              <?php }) ?>
                              <?php is_allowed('templateuploadmismer_update', function() use ($templateuploadmismer){?>
                              <a href="<?= site_url('administrator/templateuploadmismer/edit/' . $templateuploadmismer->RowID); ?>" class="label-default"><i class="fa fa-edit "></i> <?= cclang('update_button'); ?></a>
                              <?php }) ?>
                              <?php is_allowed('templateuploadmismer_delete', function() use ($templateuploadmismer){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/templateuploadmismer/delete/' . $templateuploadmismer->RowID); ?>" class="label-default remove-data"><i class="fa fa-close"></i> <?= cclang('remove_button'); ?></a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
